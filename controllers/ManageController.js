(function () {
    ...
    app.controller('ManageController', ['VnbRestangular','StateService', '$scope', function(VnbRestangular, StateService, $scope){
        ...
        manageCtrl.adjustFromDate = function(){
            var to = $scope.notice.to;
            var from = $scope.notice.from;
